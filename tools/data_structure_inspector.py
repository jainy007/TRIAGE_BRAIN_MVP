...
def inspect_data_structure():
    ...
    # Load scene summary
    try:
        df = pd.read_csv("tools/data_exploration/scene_summary.csv")
    ...
    print(f"\n📋 Other data files:")
    data_files = [
        "tools/data_exploration/scene_core_map.jsonl", 
        "tools/data_exploration/scene_full_map.jsonl", 
        "tools/data_exploration/scene_sensor_map.jsonl"
    ]
